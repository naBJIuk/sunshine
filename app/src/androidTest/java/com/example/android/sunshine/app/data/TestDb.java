    ...
    */
    public void testLocationTable() {
        ...
        if (cursor.moveToFirst()) {
            TestUtilities.validateCurrentRecord("Cursor and content values are not valid",
                    cursor, cv);
        }
    ...
    public void testWeatherTable() {
        ...
        ContentValues weatherContentValues = TestUtilities.createWeatherValues(locationId);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error validating weather test data", cursor, weatherContentValues);
